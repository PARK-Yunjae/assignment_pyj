...
import Utils.InputManager; // 이건 있어야 스태틱 쓸수 있나?
...
public class ShopController {
	...
	private void userLoginSelect(String id) {
		while (true) {
			...
			System.out.println("[1] 쇼핑");	// 1개씩 추가만
			System.out.println("[2] 장바구니 목록 확인");// 쇼핑 목록 - 내 id와 일치하는 목록만
			System.out.println("[3] 장바구니 목록 삭제"); // 1개 삭제,  아이템 목록 삭제,  일괄 삭제
			System.out.println("[4] 회원탈퇴"); // 장바구니 목록도 삭제
	...
	private void adminSelect() {
		while (true) {
			System.out.println("[1] 아이템관리");	// 아이템 추가 삭제만 - 삭제시 장바구니도 삭제
			System.out.println("[2] 카테고리관리"); // 카테고리 삭제 시 - 장바구니 아이템 전부 삭제
			System.out.println("[3] 장바구니관리"); // 카트 목록만
			System.out.println("[4] 유저관리");   	// 유저 삭제 시 장바구니 유저 목록도 삭제
			System.out.println("[5] 파일저장");	// 종료 시 파일 자동 저장
			System.out.println("[6] 파일로드");	// 시작 시에 자동 로드
			System.out.println("[0] 뒤로가기");
			int sel = InputManager.getInt("선택 >>");
